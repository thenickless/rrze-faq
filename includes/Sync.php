...
class Sync {
    ...
    public function doSync( $mode ) {
        ...
        $sync_msg = 'Synchronization completed. ' . $iCnt . __( ' FAQ fetched', 'rrze-faq' ) . '. Required time: ' . sprintf( '%.1f ', microtime( true ) - $_SERVER["REQUEST_TIME_FLOAT"] ) . __( 'seconds', 'rrze-faq' );
