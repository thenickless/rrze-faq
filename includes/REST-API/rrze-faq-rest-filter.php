...
function rest_api_filter_add_filters() {
	foreach ( get_post_types( array( 'show_in_rest' => true ), 'objects' ) as $post_type ) {
		add_filter( 'rest_' . $post_type->name . '_query', 'RRZE\Glossar\Server\rest_api_filter_add_filter_param', 10, 2 );
	}
}
...
add_action( 'rest_api_init', 'RRZE\Glossar\Server\rest_api_filter_add_filters' );
